...
**Action :** Termine la session, met à jour `.hermes/hermes/`, push tout, et quitte proprement.
...
**Action :** Affiche `.hermes/hermes/known-issues.md` et `.hermes/project/BUGS.md`.
**État :** ✅ Disponible
...
2. ✅ Lis le fichier correspondant (ex: `.hermes/skills/nook-fin/SKILL.md`)
3. ✅ Exécute **TOUTES** les étapes décrites
4. ✅ Met à jour `.hermes/hermes/` selon l'action
...
- **Consulter `.hermes/reference/commands.md`** pour les commandes techniques (git, docker, cargo...)

---

## 🔗 Liens rapides

- **Commands référence :** `.hermes/reference/commands.md`
- **Slash commands :** `.hermes/commands.md` (ce fichier)
- **Skills détaillés :** `.hermes/skills/*/SKILL.md`

---

*Pour ajouter une nouvelle commande slash : modifier ce fichier + créer le skill correspondant dans `.hermes/skills/`*
