...
> Spécialiste de la création, maintenance, et optimisation des agents/roles/skills dans .hermes/

## Responsabilités
1. **Audit régulier** du répertoire .hermes/
...
## Checklist d'audit
```
1. Lister tous les fichiers dans .hermes/
