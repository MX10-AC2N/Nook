...
```
OBLIGATOIRE :
1. .hermes/BUGS.md         → bugs actifs + historique résolutions
2. .hermes/SESSIONS.md     → sessions récentes (5 dernières minimum)
3. .hermes/TEST_REPORT.md  → état actuel des tests E2E
4. .hermes/BACKEND-BUILD-REPORT-*.md → état build Rust
5. .hermes/rules/memory-sessions.md  → résumé état projet
```
