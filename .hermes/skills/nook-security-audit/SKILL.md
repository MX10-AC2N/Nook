...
description: "Security audit of Nook codebase — OWASP Top 10, dependencies, API security. Produces report in .claude/SECURITY-REPORT.md"
---
...
### 5. Produce report
Save to `.claude/SECURITY-REPORT.md` and push to GitHub.
