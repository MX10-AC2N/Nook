...
```
Après Backend.yml  → lire .hermes/BACKEND-BUILD-REPORT-amd64.md + arm64.md
Après Frontend.yml → lire .hermes/FRONTEND-BUILD-REPORT.md
Après test-nook    → lire .hermes/TEST_REPORT.md
Après Docker.yml   → lire .hermes/DOCKER-BUILD-REPORT.md
```
