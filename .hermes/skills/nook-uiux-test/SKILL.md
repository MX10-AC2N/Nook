...
description: "Test UI/UX across pages — visual, ergonomic, responsive, accessible. Produces structured report in .hermes/UIUX-REPORT.md"
---
...
### 4. Produce report
Save to `.hermes/UIUX-REPORT.md` and push to GitHub.
