...
1. ✅ Lire `.hermes/hermes/active-session.md` → Qu'est-ce que je faisais ?
2. ✅ Lire `.hermes/hermes/known-issues.md` → Quels pièges éviter ?
3. ✅ Lire `.hermes/hermes/hermes-memory.md` → Infos critiques (tokens, comptes)
4. ✅ Vérifier `.hermes/project/project-state.md` → Où en est Nook ?

**⚠️ RÈGLE ABSOLUE :**
> SI `.hermes/hermes/` EXISTE, le lire SYSTÉMATIQUEMENT avant de répondre à l'utilisateur.
...
```bash
bash .hermes/hooks/scripts/hermes-tools-setup.sh
```
...
- [ ] J'ai lu `.hermes/hermes/active-session.md`
- [ ] J'ai lu `.hermes/hermes/known-issues.md`
