...
6. Commit TEST_REPORT.md dans .hermes/
```
...
| `generate-android-instruction.yml` | 📐 ARCHITECT | Auto-génère `.hermes/ANDROID-INSTRUCTION.md` |
...
> [`.hermes/WORKFLOW-CATALOG.md`](../WORKFLOW-CATALOG.md).
