...
> Généré par `test-nook.yml` · **2026-07-16 06:58 UTC**
...
| **Durée totale** | 8.3s |
| **Branche** | `main` |
| **Commit** | [`753c033`](https://github.com/MX10-AC2N/Nook/commit/753c0339f6a1230060d6ca3895ef479090c1bc70) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/29477494204) |
...
| 2 | Mot de passe 7 chars → 400 | 0.1s | `?` |
| 3 | Mot de passe 8 chars → accepte | 0.1s | `?` |
| 4 | User normal change pwd autre user → 403 | 0.1s | `?` |
| 5 | Mot de passe 5 chars → 400 | 0.1s | `?` |
| 6 | GET /api/health → "OK" | 0.0s | `?` |
| 7 | Upload fichier vide → 400 | 0.0s | `?` |
| 8 | GET /auth/me → 401 | 0.0s | `?` |
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/29477494204](https://github.com/MX10-AC2N/Nook/actions/runs/29477494204)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/29477494204)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-07-16 06:58 UTC*
