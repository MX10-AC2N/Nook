...
- `.hermes/SECURITY-REPORT.md` — Audit sécurité complet
- `.hermes/UIUX-REPORT.md` — Audit UI/UX complet
- `.hermes/PERFORMANCE-REPORT.md` — Audit performance
- `.hermes/DOCKER-REPORT.md` — Audit Docker
- `.hermes/DEPS-REPORT.md` — Audit dépendances (à créer)
