...
2. **Perte de contexte** entre sessions
   - **Solution :** Ce fichier `.hermes/hermes/` + restructurer tout le dossier
...
## 📂 Structure .hermes actuelle (restructurée)
...
1. ✅ Lire `.hermes/hermes/active-session.md` (état immédiat)
2. ✅ Lire `.hermes/hermes/known-issues.md` (ne pas répéter les erreurs)
3. ✅ Vérifier `.hermes/project/project-state.md` (version, branche)
4. ✅ Consulter `.hermes/reference/` selon besoin (Rust ou Svelte)
...
- Structure `.hermes` en cours de restructuration (27-04-2026)
