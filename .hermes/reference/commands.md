...
-- Voir : .hermes/reference/rust-patterns.md
```
...
.hermes/hermes/active-session.md
.hermes/hermes/known-issues.md
.hermes/hermes/hermes-memory.md
.hermes/project/project-state.md
```
...
cat .hermes/hermes/known-issues.md
...
- ❌ Ignorer `.hermes/hermes/` au démarrage
...
- ✅ Lire `.hermes/hermes/` au démarrage
