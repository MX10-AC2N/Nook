...
> Version projet : **0.5.0** | Session courante : **53** | Mis à jour : **2026-04-28**
...
> - ✅ **Documentation** : `.env.example`, `.hermes/` mis à jour
>
...
> Chacun a un skill dédié dans `.hermes/skills/` à lire avant d'intervenir.
...
Les skills sont dans `.hermes/skills/`. Chaque agent DOIT lire le skill correspondant
avec `view .hermes/skills/<skill>/SKILL.md` **avant toute intervention**.
...
- `/fini` — Termine la session proprement: resume, update .hermes docs, push state, exit.
  *Voir `.hermes/skills/nook-fin/SKILL.md` pour les details*
