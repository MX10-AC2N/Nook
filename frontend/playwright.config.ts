...
// Session 45+ — refonte tests : 4 fichiers + tests complets Nook
//
...
//   4. nook-complete     → tests complets toutes fonctionnalités
//
// fullyParallel:false + workers:1 en CI :
//   Les projets s'exécutent en séquence pour partager la même DB Docker.
...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'nook-complete',
      testMatch: '**/test-nook-complete.spec.ts',
      use: { ...devices['Desktop Chrome'] },
      dependencies: ['api-sanity'],
    },
  ],
