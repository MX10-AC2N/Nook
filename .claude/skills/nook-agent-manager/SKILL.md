...
category: "devops"
description: "Manage the .claude/ directory — audit, create, update, and delete roles/skills/rules. Ensure optimal agent ecosystem for Nook."
---
...
## Trigger
Run when:
- "Audit .claude/" or "optimize agents"
