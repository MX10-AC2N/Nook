...
> Généré par `test-nook.yml` · **2026-04-04 13:29 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 159 |
| **Durée totale** | 1m 8.7s |
| **Branche** | `develop` |
| **Commit** | [`b2bec48`](https://github.com/MX10-AC2N/Nook/commit/b2bec48e299c6139bc9269c282e08b3dfe2470a3) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/23979772143) |
...
| 4 | Login invalide → reste sur /login | 3.5s | `?` |
| 5 | Chess — POST /chess/{id}/ai-move → 200 | 3.3s | `?` |
...
| 9 | DELETE /users/{id} → supprime un utilisateur | 1.1s | `?` |
| 10 | /call/fake-id avec auth → page charge | 1.0s | `?` |
...
| ✅ | Login invalide → reste sur /login | 3.5s | |
...
| ✅ | Réactions UI — hover → picker → pill visible | 1.0s | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=64fa4d86-ae8f-4843-a3c0-e57352603547 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=64fa4d86-ae8f-4843-a3c0-e57352603547 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=64fa4d86-ae8f-4843-a3c0-e57352603547 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=64fa4d86-ae8f-4843-a3c0-e57352603547 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/23979772143](https://github.com/MX10-AC2N/Nook/actions/runs/23979772143)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/23979772143)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-04 13:29 UTC*
