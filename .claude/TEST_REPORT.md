...
> Généré par `test-nook.yml` · **2026-04-12 07:05 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 163 |
| **Durée totale** | 1m 40.6s |
| **Branche** | `develop` |
| **Commit** | [`4bbaf81`](https://github.com/MX10-AC2N/Nook/commit/4bbaf810ead95a2bb17277faaaa5c8cf1edf7f14) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/24300805373) |
...
| ✅ | Navigation /chess → accessible sans erreur | 0.7s  +1 | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=57f64a76-2169-4386-8bd8-1fd2d07a5699 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=57f64a76-2169-4386-8bd8-1fd2d07a5699 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=57f64a76-2169-4386-8bd8-1fd2d07a5699 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/24300805373](https://github.com/MX10-AC2N/Nook/actions/runs/24300805373)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/24300805373)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-12 07:05 UTC*
