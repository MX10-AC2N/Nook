...
> Généré par `test-nook.yml` · **2026-04-03 10:37 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 165 |
| **Durée totale** | 1m 16.7s |
| **Branche** | `develop` |
| **Commit** | [`d91fe2a`](https://github.com/MX10-AC2N/Nook/commit/d91fe2ada6ba58b25c3d4af3acd0573fab90b78d) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/23943254641) |
...
| 6 | Chess — POST /chess/{id}/ai-move → 200 | 2.9s | `?` |
...
| ✅ | Chess — POST /chess/{id}/ai-move → 200 | 2.9s | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=028c2956-8929-483f-9e95-2ce26557c0d6 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=028c2956-8929-483f-9e95-2ce26557c0d6 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=028c2956-8929-483f-9e95-2ce26557c0d6 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=028c2956-8929-483f-9e95-2ce26557c0d6 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/23943254641](https://github.com/MX10-AC2N/Nook/actions/runs/23943254641)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/23943254641)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-03 10:37 UTC*
