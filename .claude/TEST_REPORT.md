...
> Généré par `test-nook.yml` · **2026-04-03 10:58 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 165 |
| **Durée totale** | 1m 15.0s |
| **Branche** | `develop` |
| **Commit** | [`26e6eed`](https://github.com/MX10-AC2N/Nook/commit/26e6eedbbade6b818b97384a60d67ccaa0346c5e) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/23943774159) |
...
| 8 | /call/default_global → page charge avec titres | 1.7s | `?` |
...
| ✅ | /call/[id] sans auth → redirige vers /login | 0.2s | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=7efb8403-a0ac-43eb-b54e-4016491f1900 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=7efb8403-a0ac-43eb-b54e-4016491f1900 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=7efb8403-a0ac-43eb-b54e-4016491f1900 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=7efb8403-a0ac-43eb-b54e-4016491f1900 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/23943774159](https://github.com/MX10-AC2N/Nook/actions/runs/23943774159)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/23943774159)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-03 10:58 UTC*
