...
> Généré par `test-nook.yml` · **2026-04-10 16:28 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 159 |
| **Durée totale** | 1m 49.2s |
| **Branche** | `develop` |
| **Commit** | [`26b3e3d`](https://github.com/MX10-AC2N/Nook/commit/26b3e3d2bb4ef88bb03ff469e2ec153c37b8b607) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/24252339342) |
...
|------|------|-------|---------|
| 1 | Réactions UI — hover → picker → pill visible | 46.2s | `?` |
...
| 10 | Chess — POST /chess/{id}/ai-move → 200 | 1.9s | `?` |
...
|--------|------|-------|---------|
| ⚠️ | Réactions UI — hover → picker → pill visible | 46.2s  +1 | |
...
| ✅ | Chess — POST /chess/{id}/ai-move → 200 | 1.9s  +1 | |
...
| ✅ | Logout UI → redirigé vers /login | 0.2s  +1 | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=7bed2f84-f2c1-444d-9915-5be11e3edce4 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=7bed2f84-f2c1-444d-9915-5be11e3edce4 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=7bed2f84-f2c1-444d-9915-5be11e3edce4 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/24252339342](https://github.com/MX10-AC2N/Nook/actions/runs/24252339342)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/24252339342)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-10 16:28 UTC*
