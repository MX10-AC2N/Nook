...
> Généré par `test-nook.yml` · **2026-04-07 05:22 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 159 |
| **Durée totale** | 1m 11.1s |
| **Branche** | `develop` |
| **Commit** | [`2b7b8e7`](https://github.com/MX10-AC2N/Nook/commit/2b7b8e77c5bde626d05e124520904865568a743b) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/24065332547) |
...
| 5 | Créer partie → jouer e2→e4 → IA répond | 2.7s | `?` |
...
| 9 | Chess — POST /chess/{id}/ai-move → 200 | 1.8s | `?` |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=58eb5929-77e9-454f-8c3d-f9ed24801c8a username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=58eb5929-77e9-454f-8c3d-f9ed24801c8a username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=58eb5929-77e9-454f-8c3d-f9ed24801c8a username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=58eb5929-77e9-454f-8c3d-f9ed24801c8a username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/24065332547](https://github.com/MX10-AC2N/Nook/actions/runs/24065332547)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/24065332547)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-07 05:22 UTC*
