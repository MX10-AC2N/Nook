...
> Généré par `test-nook.yml` · **2026-04-03 10:18 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 165 |
| **Durée totale** | 1m 16.2s |
| **Branche** | `develop` |
| **Commit** | [`599876f`](https://github.com/MX10-AC2N/Nook/commit/599876f023b268959e01af2fe29772a8adb2dc68) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/23942750217) |
...
| 3 | /call/default_global → page call charge correctement | 4.1s | `?` |
| 4 | /call/default_global → page contient contenu call | 4.1s | `?` |
| 5 | Login invalide → reste sur /login | 3.3s | `?` |
| 6 | Chess — POST /chess/{id}/ai-move → 200 | 2.7s | `?` |
| 7 | Page /admin → non accessible pour user normal | 2.1s | `?` |
| 8 | /call/default_global → page charge avec titres | 1.6s | `?` |
| 9 | /call/default_global → page charge avec titre "Appel" | 1.6s | `?` |
...
| ✅ | /call/fake-id avec auth → page charge | 1.0s | |
...
| ✅ | /call/[id] sans auth → redirige vers /login | 0.3s | |
...
| ✅ | Chess — coup illégal → message erreur | 0.0s | |
| ✅ | Chess — UI plateau 8x8 (64 cases) | 0.0s | |
| ✅ | Chess — UI plateau 8x8 (64 cases) avec sélection | 0.0s | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=3d10d4ca-4358-4e49-a216-34b18d95a329 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=3d10d4ca-4358-4e49-a216-34b18d95a329 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=3d10d4ca-4358-4e49-a216-34b18d95a329 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=3d10d4ca-4358-4e49-a216-34b18d95a329 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/23942750217](https://github.com/MX10-AC2N/Nook/actions/runs/23942750217)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/23942750217)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-03 10:18 UTC*
