...
> Généré par `test-nook.yml` · **2026-04-10 10:43 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 159 |
| **Durée totale** | 1m 12.2s |
| **Branche** | `develop` |
| **Commit** | [`b4a5b17`](https://github.com/MX10-AC2N/Nook/commit/b4a5b170f38df87428e4a2d6b26334a886781229) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/24238477083) |
...
|------|------|-------|---------|
| 1 | Réactions UI — hover → picker → pill visible | 11.3s | `?` |
...
| 9 | Chess — POST /chess/{id}/ai-move → 200 | 2.1s | `?` |
...
|--------|------|-------|---------|
| ⚠️ | Réactions UI — hover → picker → pill visible | 11.3s  +1 | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=ec627e7f-b262-4355-bc8b-358057eae4ce username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=ec627e7f-b262-4355-bc8b-358057eae4ce username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=ec627e7f-b262-4355-bc8b-358057eae4ce username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/24238477083](https://github.com/MX10-AC2N/Nook/actions/runs/24238477083)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/24238477083)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-10 10:43 UTC*
