...
> Généré par `test-nook.yml` · **2026-04-07 05:58 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 159 |
| **Durée totale** | 1m 13.1s |
| **Branche** | `develop` |
| **Commit** | [`a795c6f`](https://github.com/MX10-AC2N/Nook/commit/a795c6fc81653a9b30c3987bbf0e845b034dbae0) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/24066302430) |
...
| 5 | Créer partie → jouer e2→e4 → IA répond | 3.2s | `?` |
| 6 | Chess — POST /chess/{id}/ai-move → 200 | 2.3s | `?` |
...
| ✅ | Créer partie → jouer e2→e4 → IA répond | 3.2s | |
...
| ✅ | Chess — POST /chess/{id}/ai-move → 200 | 2.3s | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=d3ebb9ed-8e5e-4848-82f2-00982d854a70 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=d3ebb9ed-8e5e-4848-82f2-00982d854a70 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=d3ebb9ed-8e5e-4848-82f2-00982d854a70 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=d3ebb9ed-8e5e-4848-82f2-00982d854a70 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/24066302430](https://github.com/MX10-AC2N/Nook/actions/runs/24066302430)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/24066302430)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-07 05:58 UTC*
