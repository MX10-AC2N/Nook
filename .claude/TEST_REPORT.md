...
> Généré par `test-nook.yml` · **2026-04-11 21:16 UTC**
...
| Indicateur | Valeur |
|-----------|--------|
| **Statut** | ✅ **SUCCÈS** · ⚠️ **1 flaky** |
| **Tests passés** | 162 |
| **Tests échoués** | 0 |
| **Tests flaky** | 1 |
| **Tests ignorés** | 0 |
| **Total** | 163 |
| **Durée totale** | 1m 41.9s |
| **Branche** | `develop` |
| **Commit** | [`1c0c2a8`](https://github.com/MX10-AC2N/Nook/commit/1c0c2a81991136d21fb474c053b31264c05a41a9) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/24291472004) |
...
| 6 | Créer partie → jouer e2→e4 → IA répond | 3.5s | `?` |
| 7 | Chess — POST /chess/{id}/ai-move → 200 | 2.7s | `?` |
...
### ❌ **user.spec.ts** — 61/62 passés · ⚠️ 1 flaky
...
| ✅ | Chess — POST /chess/{id}/ai-move → 200 | 2.7s  +1 | |
| ✅ | Avatar — composant visible avec initiales dans le chat | 2.3s  +1 | |
| ✅ | Chess — sélection pièce → coups légaux visibles (dots) | 2.1s  +1 | |
...
| ✅ | Navigation /chat → accessible sans erreur | 0.7s  +1 | |
...
| Statut | Test | Durée | Retries |
|--------|------|-------|---------|
| ✅ | Créer partie → jouer e2→e4 → IA répond | 3.5s | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=be53bb45-504a-4b10-92c9-f3d66526d9d8 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=be53bb45-504a-4b10-92c9-f3d66526d9d8 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=be53bb45-504a-4b10-92c9-f3d66526d9d8 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/24291472004](https://github.com/MX10-AC2N/Nook/actions/runs/24291472004)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/24291472004)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-11 21:16 UTC*
