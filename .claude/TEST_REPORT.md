...
> Généré par `test-nook.yml` · **2026-04-03 11:11 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 165 |
| **Durée totale** | 1m 15.1s |
| **Branche** | `develop` |
| **Commit** | [`808db92`](https://github.com/MX10-AC2N/Nook/commit/808db9281f7153ce2baf68efd97378b23ab6585c) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/23944088022) |
...
| 5 | Login invalide → reste sur /login | 3.4s | `?` |
| 6 | Page /admin → non accessible pour user normal | 2.1s | `?` |
| 7 | Chess — POST /chess/{id}/ai-move → 200 | 2.1s | `?` |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=b7690ea9-c44a-472d-89c4-4d6f9ffc6053 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=b7690ea9-c44a-472d-89c4-4d6f9ffc6053 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=b7690ea9-c44a-472d-89c4-4d6f9ffc6053 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=b7690ea9-c44a-472d-89c4-4d6f9ffc6053 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/23944088022](https://github.com/MX10-AC2N/Nook/actions/runs/23944088022)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/23944088022)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-03 11:11 UTC*
