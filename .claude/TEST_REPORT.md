...
> Généré par `test-nook.yml` · **2026-04-11 18:11 UTC**
...
| **Tests ignorés** | 1 |
| **Total** | 163 |
| **Durée totale** | 1m 47.8s |
| **Branche** | `develop` |
| **Commit** | [`da89491`](https://github.com/MX10-AC2N/Nook/commit/da894918895bec13818dac5f1c921ae552e0f69f) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/24288204107) |
...
| 2 | Chess — sélection pièce → coups légaux visibles (dots) | 12.3s | `?` |
...
| 7 | Créer partie → jouer e2→e4 → IA répond | 2.6s | `?` |
| 8 | Avatar — composant visible avec initiales dans le chat | 2.2s | `?` |
| 9 | Admin — approve + login after approve → accès complet | 2.1s | `?` |
...
|--------|------|-------|---------|
| ❌ | Chess — sélection pièce → coups légaux visibles (dots) | 12.3s  +1 | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=194217b8-f885-4c4b-ba69-b93f34369508 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=194217b8-f885-4c4b-ba69-b93f34369508 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=194217b8-f885-4c4b-ba69-b93f34369508 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/24288204107](https://github.com/MX10-AC2N/Nook/actions/runs/24288204107)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/24288204107)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-11 18:11 UTC*
