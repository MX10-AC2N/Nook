...
> Généré par `test-nook.yml` · **2026-04-04 13:50 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 159 |
| **Durée totale** | 1m 8.6s |
| **Branche** | `develop` |
| **Commit** | [`84ee879`](https://github.com/MX10-AC2N/Nook/commit/84ee879e7275a4d2670ca769c5a0a73db8a82273) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/23980050007) |
...
| 5 | Chess — POST /chess/{id}/ai-move → 200 | 2.6s | `?` |
...
| 10 | Réactions UI — hover → picker → pill visible | 1.1s | `?` |
...
| ✅ | Chess — POST /chess/{id}/ai-move → 200 | 2.6s | |
...
| ✅ | Settings UI — 3 onglets navigables | 0.1s | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=4398ff38-e09a-446b-82a8-b2d0cd77ec6b username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=4398ff38-e09a-446b-82a8-b2d0cd77ec6b username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=4398ff38-e09a-446b-82a8-b2d0cd77ec6b username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=4398ff38-e09a-446b-82a8-b2d0cd77ec6b username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/23980050007](https://github.com/MX10-AC2N/Nook/actions/runs/23980050007)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/23980050007)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-04 13:50 UTC*
