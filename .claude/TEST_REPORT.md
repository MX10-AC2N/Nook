...
> Généré par `test-nook.yml` · **2026-04-10 11:38 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 159 |
| **Durée totale** | 1m 12.5s |
| **Branche** | `develop` |
| **Commit** | [`4d17c93`](https://github.com/MX10-AC2N/Nook/commit/4d17c93fedae25db27dd178faed3ad7e05babdc8) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/24240446972) |
...
| 7 | Chess — POST /chess/{id}/ai-move → 200 | 2.3s | `?` |
...
| ✅ | Chess — POST /chess/{id}/ai-move → 200 | 2.3s  +1 | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=bff62bb0-f0ba-4c57-9d74-adde107a2822 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=bff62bb0-f0ba-4c57-9d74-adde107a2822 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=bff62bb0-f0ba-4c57-9d74-adde107a2822 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/24240446972](https://github.com/MX10-AC2N/Nook/actions/runs/24240446972)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/24240446972)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-10 11:38 UTC*
