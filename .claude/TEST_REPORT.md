...
> **Dernière mise à jour : 2026-03-05 19:21 UTC**
...
| **Tests ignorés** | 0 |
| **Branche** | `develop` |
| **Commit** | [`e0f5b3b`](https://github.com/MX10-AC2N/Nook/commit/e0f5b3b81a6a82a8ef6466bc7cdb82532754f889) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/22730936500) |
...
```
nook  | [2m2026-03-05T18:36:24.104954Z[0m [33m WARN[0m [2mnook_backend[0m[2m:[0m ⚠️  Aucun utilisateur trouvé - création de l'administrateur initial
```
