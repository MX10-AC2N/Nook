...
> Généré par `test-nook.yml` · **2026-04-03 09:38 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 165 |
| **Durée totale** | 1m 15.3s |
| **Branche** | `develop` |
| **Commit** | [`4aefaef`](https://github.com/MX10-AC2N/Nook/commit/4aefaefeb104d1b662b566b2ae07ac9eb1bd3185) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/23941657143) |
...
| 4 | /call/default_global → page call charge correctement | 4.1s | `?` |
| 5 | Login invalide → reste sur /login | 3.3s | `?` |
| 6 | Chess — POST /chess/{id}/ai-move → 200 | 2.8s | `?` |
| 7 | Page /admin → non accessible pour user normal | 2.1s | `?` |
| 8 | /call/default_global → page charge avec titre "Appel" | 1.7s | `?` |
...
| ✅ | Chess — POST /chess/{id}/ai-move → 200 | 2.8s | |
| ✅ | /call/default_global → page charge avec titre "Appel" | 1.7s | |
...
| ✅ | Navigation /help → accessible sans erreur | 0.6s | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=ca820bcb-e581-417d-ac96-ca8308d92822 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=ca820bcb-e581-417d-ac96-ca8308d92822 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=ca820bcb-e581-417d-ac96-ca8308d92822 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=ca820bcb-e581-417d-ac96-ca8308d92822 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/23941657143](https://github.com/MX10-AC2N/Nook/actions/runs/23941657143)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/23941657143)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-03 09:38 UTC*
