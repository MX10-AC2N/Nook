...
> Généré par `test-nook.yml` · **2026-04-03 12:02 UTC**
...
| **Tests ignorés** | 0 |
| **Total** | 165 |
| **Durée totale** | 1m 15.2s |
| **Branche** | `develop` |
| **Commit** | [`8942a5c`](https://github.com/MX10-AC2N/Nook/commit/8942a5c8611f452dc09fd9bc79ba2821f1c49378) |
| **Run CI** | [Voir le run complet](https://github.com/MX10-AC2N/Nook/actions/runs/23945347414) |
...
| 6 | Chess — POST /chess/{id}/ai-move → 200 | 2.1s | `?` |
...
| Statut | Test | Durée | Retries |
|--------|------|-------|---------|
| ⚠️ | Chess resign → status finished | 0.1s  +1 | |
...
| ✅ | Chess — POST /chess/{id}/ai-move → 200 | 2.1s | |
...
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=efe46669-b14f-4bf6-acfc-4f50a4efc330 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=efe46669-b14f-4bf6-acfc-4f50a4efc330 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=efe46669-b14f-4bf6-acfc-4f50a4efc330 username=e2e_ci
WARN nook_backend::auth: Tentative d'accès admin refusée (non-admin) user_id=efe46669-b14f-4bf6-acfc-4f50a4efc330 username=e2e_ci
```
...
> - **URL du run :** [https://github.com/MX10-AC2N/Nook/actions/runs/23945347414](https://github.com/MX10-AC2N/Nook/actions/runs/23945347414)
> - **Chemin local (CI) :** `frontend/playwright-report/`

Pour examiner visuellement les échecs :
1. Télécharger l'artifact `playwright-report` depuis le [run CI](https://github.com/MX10-AC2N/Nook/actions/runs/23945347414)
...
*Rapport généré par `scripts/generate-test-report.py` — 2026-04-03 12:02 UTC*
