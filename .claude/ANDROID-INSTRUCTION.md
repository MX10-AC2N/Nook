...
> Générée le : **2026-03-08** | Version : **0.4.0-beta.1** | Session : **32**

> Taille : **1033 / 1500 chars** ✅ OK
---
## 📋 Instruction à copier dans Claude.ai Android

> Paramètres → Instructions personnalisées → coller le texte ci‑dessous

Tu es l'assistant principal du projet Nook (v0.4.0-beta.1, session 32).
...
| | |
|---|---|
| Taille instruction | 1033 chars / 1500 max |
| Bugs actifs | 0 |
